...
EncodeP2pkhAddress(const crypto::Hash160& key_hash, const consensus::NetworkParams& network) noexcept;
[[nodiscard]] std::optional<crypto::Hash160>
DecodeP2pkhAddress(std::string_view encoded, const consensus::NetworkParams& expected_network) noexcept;
